...
// @desc Create new source code
exports.createSourceCode = async (req, res) => {
    try {
        const { name, description, srcCode, language, images, price } = req.body;
...
exports.updateSourceCode = async (req, res) => {
    try {
        ...
        if (!updatedCode) return res.status(404).json({ message: "Source Code not found" });
...
exports.deleteSourceCode = async (req, res) => {
    try {
        ...
        if (!deletedCode) return res.status(404).json({ message: "Source Code not found" });
